...
static std::string rsa_priv_key = R"(-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----)";
static std::string rsa_pub_key = R"(-----BEGIN PUBLIC KEY-----
...
YwIDAQAB
-----END PUBLIC KEY-----)";
static std::string rsa_pub_key_invalid = R"(-----BEGIN PUBLIC KEY-----
